...
- **Ubicua** ([AGENTS.md](../AGENTS.md)) — inyectada en cada sesión, gravando la atención de cada sesión, así que contiene una sola frase: _cuando termina una implementación o una corrección, delega la verificación en los agentes de revisión aplicables antes de informar de la finalización._
- **Momentánea** ([skills/](../skills/)) — se leen solo cuando llega su momento: [git](../skills/git/SKILL.md) en el momento del commit, [prompting](../skills/prompting/SKILL.md) al editar prompts. El detalle aquí no le cuesta nada a ningún otro momento.
...
Los textos de las reglas no se duplican aquí — una copia se pudriría en silencio. El módulo al completo:

| Archivo | Contiene |
|---|---|
| [AGENTS.md](../AGENTS.md) | la única frase ubicua |
| [agents/review.md](../agents/review.md) | revisión adversarial: primero la existencia, luego la corrección |
| [agents/security.md](../agents/security.md) | revisión de seguridad anclada al OWASP Top 10 |
| [agents/accessibility.md](../agents/accessibility.md) | revisión de accesibilidad anclada a WCAG 2.2 AA |
| [skills/git/SKILL.md](../skills/git/SKILL.md) | convenciones de commit, squash y rebase |
| [skills/prompting/SKILL.md](../skills/prompting/SKILL.md) | qué leer antes de editar cualquiera de los anteriores |
