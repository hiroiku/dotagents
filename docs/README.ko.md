...
├── code/             주석은 무엇을 위한 것인가
├── git/              커밋 제목, squash, rebase, worktree
├── testing/          좋은 테스트의 열두 가지 성질
├── gate/             작업 중의 전체 검사와 기다리기만 하는 명령을 멈추는 hook
